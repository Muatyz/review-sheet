...
{\color{white}{In the mean-field approximation, the Hamiltonian can be written as
...
\begin{align*}
  ...
  U\sum_{i}\big(
    ...
    + n_{i\downarrow}\langle  n_{i\uparrow}\rangle - \langle n_{i\uparrow}\rangle\langle n_{i\downarrow}\rangle
    \big) \\
...
{\color{white}{  For this case, the interactions are weak, so we expect that the hopping term is dominant. Thus we have
  \begin{align*}
 ...
 {\color{white}{ When $U$ is large, we expect no double occupancy. For this case, the mean-field values are chosen as
  \begin{align*}
  ...
  {\color{white}{Another choice when $U$ is large is to give
  \begin{align*}
...
{\color{white}{  When $V$ is much stronger, we expect a double occupancy will occur. Thus the mean-field values are chosen as
  \begin{align*}
